...
public class GyroDriverOperated extends CommandBase {
   ...
   */
  public GyroDriverOperated(DriveTrainSubsystem driveTrain, MotorSubsystem conveyor, ShooterSubsystem shooter,
  ...
  public void initialize() {
    driveTrain.setCorrectionAngle(driveTrain.getGyroAngle());
  }
  ...
  public void execute() {
    ...
    if(slowButton){
      driveTrain.driveCorrected(slowDownFactor * horizontalSpeed, slowDownFactor * -forwardSpeed, slowDownFactor * rotation);
    }else{
      driveTrain.driveCorrected(horizontalSpeed, -forwardSpeed, rotation);
    }
